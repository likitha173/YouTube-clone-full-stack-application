    ...
    <div className={open ? "edit-channel active" : "edit-channel"}>
      <div className={`wrapper ${state?.theme}`}>
        <div className="banner">
          <ImageWithFallback
            src={banner ? URL.createObjectURL(banner) : services.getBannerUrl(user?.banner)}
        ...
        <div className="infos">
          <div className="profile-wrapper">
            <ImageWithFallback
              src={profile ? URL.createObjectURL(profile) : services.getProfileUrl(user?.profile)}
              fallback={DefaulProfile}
              alt=""
              className="avatar"
            />
