        ...
        <div className="register-card">
          ...
          <form className="register-form" onSubmit={handleSubmit}>
            ...
            <div className="register-terms">
              <p>By creating an account, you agree to the <a href="/terms">Terms of Service</a> and <a href="/privacy">Privacy Policy</a></p>
            </div>

            <div className="form-actions">
              <Link to="/login" className="sign-in-instead-btn">
                Sign in instead
              </Link>
              <button type="submit" className="create-account-btn-submit">
                Create account
              </button>
            </div>
          </form>
